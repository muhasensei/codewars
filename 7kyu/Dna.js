...
function with one side of the DNA (string, except for Haskell); you need to get 
...
function DNAStrand(dna){
    return dna.replace(/A/g, 't').replace(/T/g, 'a').replace(/C/g, 'g').replace(/G/g, 'c').toUpperCase().toUpperCase()
}

console.log(DNAStrand('AATTGGC'));

//replace symbols with their lowwercase pairs so that it would not be replaced by other replace method
